...
| ID  | Name | Article |
| :-- | :--- | :------ |
{del}| 22587 |  Ручка-профиль Накладная L=1.0 m Латунь (Не используется)                     | A26-53-12-BRASS            |
...
{del}| 24319 |  Ручка торцевая RT.06, L.896, отделка "Золото полуматовая"  (Не используется) | RT.06.896.1036/ML112       |
