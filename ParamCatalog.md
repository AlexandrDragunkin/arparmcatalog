...
:::{tip}
Для всех элементов каталога, имеющих в составе распашную дверь действует правило.

Если на сайте задан парметр  ручка Hettich. Требуется передать парметр ID толкателя и обнулить саму ручку.
