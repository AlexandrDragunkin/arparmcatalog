...
| ID    | Name                                                                         | Article                    |
| :---- | :--------------------------------------------------------------------------- | :------------------------- |
| 22587 |  {del}'Ручка-профиль Накладная L=1.0 m Латунь (Не используется)'                     | A26-53-12-BRASS            |
...
| 24319 |  {del}'Ручка торцевая RT.06, L.896, отделка "Золото полуматовая"  (Не используется)' | RT.06.896.1036/ML112       |
