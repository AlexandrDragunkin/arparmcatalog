...
| :---------------------------------------------------------------------------------------------------------------------------------- | :-------- | :-------- |
| ~~Петля для накладных дверей Firmax Advanced PLUS, без пружины угол открывания 110°, 48мм (Не используется c 26.02.2026)~~          | FRM8100.P | ~~25292~~ |
| ~~Петля полунакладная Firmax Advanced PLUS, Anyway Click-On, без пружиныугол открывания 110°, 48мм (Не используется c 26.02.2026)~~ | FRM8101.P | ~~25294~~ |
| Петля BLUTEK_Prime полунакладная, саморез. Без пружины                                                                              | Прайм-13  | 28232     |
| Петля BLUTEK_Prime накладная, саморез. Без пружины                                                                                  | Прайм-11  | 28231     |

```sql
UPDATE [NGxxxx81].[dbo].[TProtoPar]
SET DefValue = 28236
WHERE LibID = 18 
  AND ParName = 'p_type' 
  AND DefValue = 24518;
...
| 22818      | Белый Муар                   | ввести 13.01.2026  для  139 |
...
| 8403       | Латунь(анод)          | ввести 25.04.2026  для 132 |
...
| MaterialID | MaterialName | Примечания                  |
| :--------- | :----------- | :-------------------------- |
| ~~22437~~  | Белый Муар   | убрать 13.01.2026  для  158 |
